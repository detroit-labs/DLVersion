...
// DLVersion
#define COCOAPODS_POD_AVAILABLE_DLVersion
#define COCOAPODS_VERSION_MAJOR_DLVersion 0
#define COCOAPODS_VERSION_MINOR_DLVersion 1
#define COCOAPODS_VERSION_PATCH_DLVersion 0
